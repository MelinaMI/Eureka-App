...
import com.catedra.eureka.databinding.FragmentReporteEncontradoBinding

class EncontreUnaMascotaFragment : BaseCrearReporteFragment(R.layout.fragment_reporte_encontrado) {

    private var _binding: FragmentReporteEncontradoBinding? = null
    private val binding get() = _binding!!

    override val estadoReporte = EstadoReporte.PUBLICADO

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        _binding = FragmentReporteEncontradoBinding.bind(view)
    ...
    override fun configurarVistasEspecificas() {
        with(binding) {
            ...
            dropdownAnimal.doAfterTextChanged { actualizarEstadoBoton() }
            dropdownSexo.doAfterTextChanged { actualizarEstadoBoton() }
            dropdownTamanio.doAfterTextChanged { actualizarEstadoBoton() }
            ...
            fabFoto.setOnClickListener { fotoService.abrirCamara() }
